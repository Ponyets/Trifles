 ...
 * @author Google, Inc.
 */
public final class Bills extends GenericJson {
   ...
   */
  public Bills setItems(java.util.List<Bill> items) {
    this.items = items;
    return this;
  }
   ...
   * example, a request that returns a single {@link Bills} would include the response headers,
   * while a request which returns an array of {@link Bills}, would have a non-null response header
