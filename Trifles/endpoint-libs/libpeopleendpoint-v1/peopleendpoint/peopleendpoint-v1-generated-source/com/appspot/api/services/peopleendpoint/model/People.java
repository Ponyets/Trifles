 ...
 * @author Google, Inc.
 */
public final class People extends GenericJson {
   ...
   * example, a request that returns a single {@link People} would include the response headers,
   * while a request which returns an array of {@link People}, would have a non-null response header
